...
<body>
	...
	<div align="center">
		...
		<p>
			...
			<a href="webresources/linkchecker/getDetailedResults">Get the
				Detailed Linkcheck results for a repository</a>
			(example:getDetailedResults?repo=a_repo_name)<br>
		<form action="uploadFile.jsp" method="post"
			enctype="multipart/form-data">
			<table>
				<tr>
					<td><label for="file">File to link check(only zip
							format):</label> <input type="file" name="file" id="file"></td>
